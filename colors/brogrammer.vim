...
hi Comment ctermfg=247 ctermbg=NONE cterm=NONE guifg=#606060 guibg=NONE gui=italic
...
hi NonText ctermfg=198 ctermbg=234 cterm=NONE guifg=#30312a guibg=#1a1a1a gui=NONE
hi Number ctermfg=215 ctermbg=NONE cterm=NONE guifg=#6c71c4 guibg=NONE gui=NONE
...
hi SpecialKey ctermfg=33 ctermbg=236 cterm=NONE guifg=#f1530f guibg=#1a1a1a gui=NONE
